...
contract CustomCBDCToken is ERC20, InterchainTokenStandard, Minter {
    ...
    function interchainTokenId() public view override returns (bytes32 tokenId) {
        tokenId = IInterchainTokenService(interchainTokenServiceAddress)
            .interchainTokenId(deployer, salt);
        return tokenId;
    }
}
